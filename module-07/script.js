...
console.log(`
Task 2 — Simple Math Calculator. Create two number variables and print the results of the five basic arithmetic operations.
...
console.log(`
Task 3 — Student Information. Store student details in variables of the appropriate type and print them.
...
console.log(`
Task 4 — Identify Data Types. Use the typeof operator to check the data type of each variable.
...
console.log(`
Task 5 — Variable Naming Challenge. Only names that follow JavaScript's identifier rules (start with a letter, $, or _; no hyphens; not a reserved keyword) are valid.
...
console.log(`
Task 6 — Personal Bio. Store personal details and print a friendly, formatted introduction.
...
console.log(`
Task 7 — Arithmetic Practice. Take two numbers and print the results of all five arithmetic operations, matching the example format.
...
console.log(`
Task 8 — Shorthand Operators. Apply each shorthand operator to score and print the value after every step.
...
console.log(`
Task 9 — Mini Coding Challenge. Calculate the total price, discount amount, and final price for a purchase.
...
console.log(`
Mini Project — Personal Introduction Card. A complete program that stores personal information and prints a formatted profile card.
...
console.log(`
Bonus Challenge — Shopping Bill. CalculatorCalculate a subtotal, tax amount, and grand total, then print a neat bill.
