...
// short, clean, and scalable to 10 or 10 million
for (let i = 0; i < 10; i++) {
  console.log("Show me something");
}

// Repetition means doing the same action again and again. We do it every day without even noticing.
