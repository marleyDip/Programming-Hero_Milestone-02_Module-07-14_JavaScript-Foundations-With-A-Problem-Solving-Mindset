...
score += 10;
console.log("After +=10:", score); // After +=10: 60

score -= 5;
console.log("After -=5:", score); // After -=5: 55

score *= 2;
console.log("After *=2:", score); // After *=2: 110

score /= 5;
console.log("After /=5:", score); // After /=5: 22

score %= 4;
console.log("After %=4:", score); // After %=4: 2
