 ...
 *
 * The Three Loops
 * 1. for - counted iteration
 * 2. while - condition driven
 * 3. do...while - run first, check-later
 *
 * Decision Making
 * - Comparison table
 * - Where to use each
...
let i = 11;
while (i > 1) {
  console.log("Using While Loop, i -->", i - 1);
  i--;
}

let i = 10;
while (i >= 1) {
  console.log("Using While Loop, i -->", i);
...
for (let i = 1; i <= 10; i++) {
  ...
  console.log(\`│ \${number} x \${i} = \${(number * i).toString().padEnd(19)}│\`);
  // console.log(number + " " + "x" + " " + i + " " + "=" + " " + number * i);
...
console.log(
  "\\nSum of all even numbers from 2 to 50 or Final Sum of Even =",
  evenSum,
);
